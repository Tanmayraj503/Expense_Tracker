...
export default function ExpenseButton() {
  return (
    <>
      ...
      <div className="px-6">
        <div className="rounded-xl border-2 border-gray-500 dark:border-[#605448] max-w-140 p-4 dark:bg-[#221E1A]">
          <div className=" dark:text-black flex flex-col gap-3 px-4">
            ...
            <div className=" dark:text-black flex flex-col gap-2 ">
              ...
              <input type="number" placeholder="0.00" required className="bg-amber-50 dark:bg-amber-100 rounded-xl p-4" />
            </div>
            <div className=" dark:text-black flex flex-col gap-2 ">
